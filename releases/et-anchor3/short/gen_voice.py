...
TEXT=("Got a JPG and the words are stuck inside? "
      "Open Extract Text, hit Upload File, pick your image. "
      "Boom, every line comes out as real text. "
      "Copy it, or save a clean file. Free, right in Chrome.")
