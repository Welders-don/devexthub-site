...
1. **Future Tools — висит 22 дня** (подан 03.08, все 4). Единственная поданная жирная площадка (DR~72) без подтверждения. Проверить, залистились ли; если нет — писать Matt Wolfe или списывать.
