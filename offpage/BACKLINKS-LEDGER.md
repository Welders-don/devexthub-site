...
| SaaSHub | ~79 | ✅ | ✅ | ✅ | ✅ | ВСЕ 4 залиты. ET+IE 30.07 free, имена брендированы «... by Devexthub» (голое «Extract Text from Image» было занято). ET verified сразу. «Заморозка» = лимит N продуктов на ревью одновременно, освобождается когда предыдущий проходит, НЕ по календарю |
